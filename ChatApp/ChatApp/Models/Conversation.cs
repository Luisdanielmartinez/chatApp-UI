   ...
   public class Conversation:INotifyPropertyChanged
    ...
    public static class Conversations
    {
        public static List<Conversation> All = new List<Conversation>
        {
            ...
            new Conversation{Subject="Expired - Anthony",Body=" aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.",Category="Beautiful & Elegant Mansion",IsAccepted=true, UserProfilePicture="https://randomuser.me/api/portraits/women/70.jpg"}
        };
    }
}
